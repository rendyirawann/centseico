...
<body>
    ...
    <!-- Start menu Area -->
	  ...
	  <div class="form-group">
          <label for="menu1">Pesanan Atas Nama</label>
      ...
      if(isset($_POST['konfirm'])) {
          ...
          $insert = mysqli_query($koneksi, "INSERT INTO pemesanan (nama_pemesan, tanggal_pemesanan, total_belanja, status) VALUES ('$nama_pemesan', '$tanggal_pemesanan', '$totalbelanja', 'pending')");
          ...
          {
            $insert = mysqli_query($koneksi, "INSERT INTO pemesanan_produk (nama_pemesan, id_pemesanan, id_menu, jumlah) 
              VALUES ('$nama_pemesan', '$id_terbaru', '$id_menu', '$jumlah') ");
          }          
